...
const Card = ({ children, title, fancy, error, customStyles }) => {
  return (
    <StyledCard customStyles={customStyles} error={error} fancy={fancy}>
      {title && (
...
const StyledCard = styled.div`
  ...
  border-radius: 5px;
  border: ${(props) =>
    props.error ? 'none' : `1px solid ${props.theme.color.gray.three}`};
